...
output_data = open("speed_se_1.txt", "w")
...
for line in input_data:
    ...
    if(pitch_type == '' or start_speed == '' or end_speed == ''): continue
    if(pitch_type == 'FA' or pitch_type =='AB'): continue

    output_data.write(pitch_type + "\t" + start_speed + "\t" + end_speed + "\n")
